...
- **Demo:** run 01 (same code, gpt-4.1-mini then gpt-4o), then 02-vision (describe an image). Image generation (03) is talk-or-run: it needs an image-capable endpoint (OpenAI/Azure OpenAI); the IImageGenerator code is the same, you swap the provider.
